 ...
 */
class getSalleClasseRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\SalleClasseRepository' shared autowired service.
     *
     * @return \App\Repository\SalleClasseRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'SalleClasseRepository.php';

        return $container->privates['App\\Repository\\SalleClasseRepository'] = new \App\Repository\SalleClasseRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
