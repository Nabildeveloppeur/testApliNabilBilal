...
class __TwigTemplate_c8659e05ef5fe672514080511a7df0bd extends Template
{
    private $source;
    private $macros = [];
    ...
    ";
        // line 8
        echo twig_include($this->env, $context, "session/_form.html.twig", ["button_label" => "Mettre a jour"]);
        echo "
...
{% block body %}
    ...
    {{ include('session/_form.html.twig', {'button_label': 'Mettre a jour'}) }}
...
{% endblock %}
", "session/edit.html.twig", "C:\\wamp64\\www\\bilal-project-main\\templates\\session\\edit.html.twig");
    }
}
