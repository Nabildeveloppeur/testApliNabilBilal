...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(private array $buildParameters = [], protected string $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\EmargementApiController' => 'getEmargementApiControllerService',
            'App\\Controller\\EmargementController' => 'getEmargementControllerService',
            'App\\Controller\\EmargerController' => 'getEmargerControllerService',
            'App\\Controller\\EmploiTempsController' => 'getEmploiTempsControllerService',
            ...
            'App\\Controller\\MatiereApiController' => 'getMatiereApiControllerService',
        ...
        $this->privates['service_container'] = static function ($container) {
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'web-token'.\DIRECTORY_SEPARATOR.'jwt-bundle'.\DIRECTORY_SEPARATOR.'DataCollector'.\DIRECTORY_SEPARATOR.'JoseCollector.php';
            ...
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'web-token'.\DIRECTORY_SEPARATOR.'jwt-bundle'.\DIRECTORY_SEPARATOR.'DataCollector'.\DIRECTORY_SEPARATOR.'AlgorithmCollector.php';
            include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'web-token'.\DIRECTORY_SEPARATOR.'jwt-bundle'.\DIRECTORY_SEPARATOR.'DataCollector'.\DIRECTORY_SEPARATOR.'KeyCollector.php';
     ...
     */
    protected static function getClaimCheckerManagerFactoryService($container)
    {
        ...
        $instance->add('nbf', ($container->privates['Jose\\Component\\Checker\\NotBeforeChecker'] ?? self::getNotBeforeCheckerService($container)));
     ...
     */
    protected static function getHeaderCheckerManagerFactoryService($container)
    {
        $a = ($container->services['event_dispatcher'] ?? self::getEventDispatcherService($container));
     ...
     */
    protected static function getAlgorithmManagerFactoryService($container)
    {
     ...
     */
    protected static function getKeyAnalyzerManagerService($container)
    {
     ...
     */
    protected static function getKeysetAnalyzerManagerService($container)
    {
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('UJnQz-n-rt', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
    ...
    {
        return $container->services['cache.system'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('3AWDeiofBn', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->services['cache.validator_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('KHW+J5K95J', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDoctrine_Orm_DefaultEntityManagerService($container, $lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Repository\\EmargerRepository' => ['privates', 'App\\Repository\\EmargerRepository', 'getEmargerRepositoryService', true],
            ...
            'App\\Repository\\SalleClasseRepository' => ['privates', 'App\\Repository\\SalleClasseRepository', 'getSalleClasseRepositoryService', true],
            ...
            'App\\Repository\\EmargerRepository' => '?',
            ...
            'App\\Repository\\SalleClasseRepository' => '?',
    ...
    protected static function getEventDispatcherService($container)
    {
        ...
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\HeaderCheckedSuccessEvent', [#[\Closure(name: 'Jose\\Bundle\\JoseFramework\\DataCollector\\CheckerCollector')] fn () => ($container->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\CheckerCollector'] ?? self::getCheckerCollectorService($container)), 'catchHeaderCheckSuccess'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\HeaderCheckedFailureEvent', [#[\Closure(name: 'Jose\\Bundle\\JoseFramework\\DataCollector\\CheckerCollector')] fn () => ($container->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\CheckerCollector'] ?? self::getCheckerCollectorService($container)), 'catchHeaderCheckFailure'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\ClaimCheckedSuccessEvent', [#[\Closure(name: 'Jose\\Bundle\\JoseFramework\\DataCollector\\CheckerCollector')] fn () => ($container->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\CheckerCollector'] ?? self::getCheckerCollectorService($container)), 'catchClaimCheckSuccess'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\ClaimCheckedFailureEvent', [#[\Closure(name: 'Jose\\Bundle\\JoseFramework\\DataCollector\\CheckerCollector')] fn () => ($container->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\CheckerCollector'] ?? self::getCheckerCollectorService($container)), 'catchClaimCheckFailure'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\JWEDecryptionSuccessEvent', [#[\Closure(name: 'Jose\\Bundle\\JoseFramework\\DataCollector\\JWECollector')] fn () => ($container->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\JWECollector'] ?? self::getJWECollectorService($container)), 'catchJweDecryptionSuccess'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\JWEDecryptionFailureEvent', [#[\Closure(name: 'Jose\\Bundle\\JoseFramework\\DataCollector\\JWECollector')] fn () => ($container->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\JWECollector'] ?? self::getJWECollectorService($container)), 'catchJweDecryptionFailure'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\JWEBuiltSuccessEvent', [#[\Closure(name: 'Jose\\Bundle\\JoseFramework\\DataCollector\\JWECollector')] fn () => ($container->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\JWECollector'] ?? self::getJWECollectorService($container)), 'catchJweBuiltSuccess'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\JWEBuiltFailureEvent', [#[\Closure(name: 'Jose\\Bundle\\JoseFramework\\DataCollector\\JWECollector')] fn () => ($container->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\JWECollector'] ?? self::getJWECollectorService($container)), 'catchJweBuiltFailure'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\JWSVerificationSuccessEvent', [#[\Closure(name: 'Jose\\Bundle\\JoseFramework\\DataCollector\\JWSCollector')] fn () => ($container->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\JWSCollector'] ?? self::getJWSCollectorService($container)), 'catchJwsVerificationSuccess'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\JWSVerificationFailureEvent', [#[\Closure(name: 'Jose\\Bundle\\JoseFramework\\DataCollector\\JWSCollector')] fn () => ($container->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\JWSCollector'] ?? self::getJWSCollectorService($container)), 'catchJwsVerificationFailure'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\JWSBuiltSuccessEvent', [#[\Closure(name: 'Jose\\Bundle\\JoseFramework\\DataCollector\\JWSCollector')] fn () => ($container->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\JWSCollector'] ?? self::getJWSCollectorService($container)), 'catchJwsBuiltSuccess'], 0);
        $instance->addListener('Jose\\Bundle\\JoseFramework\\Event\\JWSBuiltFailureEvent', [#[\Closure(name: 'Jose\\Bundle\\JoseFramework\\DataCollector\\JWSCollector')] fn () => ($container->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\JWSCollector'] ?? self::getJWSCollectorService($container)), 'catchJwsBuiltFailure'], 0);
    ...
    protected static function getHttpKernelService($container)
    {
        ...
        $b->allowControllers(['App\\Kernel', 'App\\Controller\\AdminController', 'App\\Controller\\EleveController', 'App\\Controller\\EmargementApiController', 'App\\Controller\\EmargementController', 'App\\Controller\\EmargerController', 'App\\Controller\\EmploiTempsController', 'App\\Controller\\FormateurController', 'App\\Controller\\FormationController', 'App\\Controller\\IndexController', 'App\\Controller\\InscriptionController', 'App\\Controller\\LoginController', 'App\\Controller\\MatiereApiController', 'App\\Controller\\PromotionController', 'App\\Controller\\SessionController', 'App\\Controller\\UtilisateurController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
     ...
     */
    protected static function getCheckerCollectorService($container)
    {
        ...
        $b = ($container->services['Jose\\Bundle\\JoseFramework\\Services\\HeaderCheckerManagerFactory'] ?? self::getHeaderCheckerManagerFactoryService($container));
     ...
     */
    protected static function getJWSCollectorService($container)
    {
    ...
    /**
     * Gets the private 'Jose\Bundle\JoseFramework\DataCollector\JoseCollector' shared autowired service.
     *
     * @return \Jose\Bundle\JoseFramework\DataCollector\JoseCollector
     */
    protected static function getJoseCollectorService($container)
    {
        $container->privates['Jose\\Bundle\\JoseFramework\\DataCollector\\JoseCollector'] = $instance = new \Jose\Bundle\JoseFramework\DataCollector\JoseCollector();
        ...
        $instance->add(new \Jose\Bundle\JoseFramework\DataCollector\KeyCollector(($container->services['Jose\\Component\\KeyManagement\\Analyzer\\KeyAnalyzerManager'] ?? self::getKeyAnalyzerManagerService($container)), ($container->services['Jose\\Component\\KeyManagement\\Analyzer\\KeysetAnalyzerManager'] ?? self::getKeysetAnalyzerManagerService($container))));
    ...
    {
        return $container->privates['cache.asset_mapper'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('V5+EiO4YPl', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        $a = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('UJhlFiOhv6', 0, ($container->targetDir.''.'/pools/app'), ($container->privates['cache.default_marshaller'] ??= new \Symfony\Component\Cache\Marshaller\DefaultMarshaller(NULL, true)));
        $a->setLogger(($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container)));
    ...
    {
        return $container->privates['cache.property_info'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('V6UCkSUfvZ', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.security_expression_language'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('VyomPkTPg3', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.serializer'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('5E3Z77GO2j', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    {
        return $container->privates['cache.validator'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('fJT+kaMBQf', 0, $container->getParameter('container.build_id'), ($container->targetDir.''.'/pools/system'), ($container->privates['monolog.logger.cache'] ?? self::getMonolog_Logger_CacheService($container))));
    }
    ...
    protected static function getDebug_SerializerService($container)
    {
        ...
        $d = ($container->services['Jose\\Component\\Signature\\Serializer\\JWSSerializerManagerFactory'] ?? self::getJWSSerializerManagerFactoryService($container));
        $e = ($container->services['Jose\\Component\\Encryption\\Serializer\\JWESerializerManagerFactory'] ?? self::getJWESerializerManagerFactoryService($container));
        $f = ($container->services['translator'] ?? self::getTranslatorService($container));
        $g = ($container->privates['serializer.mapping.class_metadata_factory'] ?? self::getSerializer_Mapping_ClassMetadataFactoryService($container));

        $h = new \Symfony\Component\Serializer\NameConverter\MetadataAwareNameConverter($g);
        $i = new \Symfony\Component\Serializer\Mapping\ClassDiscriminatorFromClassMetadata($g);

        return $container->privates['debug.serializer'] = new \Symfony\Component\Serializer\Debug\TraceableSerializer(new \Symfony\Component\Serializer\Serializer([new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($b), $c), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Jose\Bundle\JoseFramework\Serializer\JWSSerializer($d), $c), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Jose\Bundle\JoseFramework\Serializer\JWESerializer($e), $c), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), $c), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true, translator: $f), $c), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), $c), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\TranslatableNormalizer($f), $c), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), $c), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $h), $c), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($g, $h, $a, $i, NULL)), $c), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), $c), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), $c), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), $c), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), $c), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($container->privates['mime_types'] ?? self::getMimeTypesService($container))), $c), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), $c), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), $c), new \Symfony\Component\Serializer\Debug\TraceableNormalizer(new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($g, $h, $b, $a, $i, NULL), $c)], [new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\XmlEncoder(), $c), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\JsonEncoder(NULL, NULL), $c), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), $c), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Symfony\Component\Serializer\Encoder\CsvEncoder(), $c), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Jose\Bundle\JoseFramework\Serializer\JWSEncoder($d), $c), new \Symfony\Component\Serializer\Debug\TraceableEncoder(new \Jose\Bundle\JoseFramework\Serializer\JWEEncoder($e), $c)]), $c);
    }
    ...
    protected static function getTwigService($container)
    {
        ...
        $a->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'security-bundle/Resources/views'), '!Security');
        $a->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'web-token'.\DIRECTORY_SEPARATOR.'jwt-bundle/Resources/views'), 'JoseFramework');
        $a->addPath((\dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'web-token'.\DIRECTORY_SEPARATOR.'jwt-bundle/Resources/views'), '!JoseFramework');
        ...
        return [
            ...
            'data_collector.templates' => [
                ...
                'Jose\\Bundle\\JoseFramework\\DataCollector\\JoseCollector' => [
                    0 => 'jose_collector',
                    1 => '@JoseFramework/data_collector/template.html.twig',
                ],
