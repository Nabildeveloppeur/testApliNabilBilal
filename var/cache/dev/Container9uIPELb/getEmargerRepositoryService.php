 ...
 */
class getEmargerRepositoryService extends App_KernelDevDebugContainer
{
    /**
     * Gets the private 'App\Repository\EmargerRepository' shared autowired service.
     *
     * @return \App\Repository\EmargerRepository
     */
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'src'.\DIRECTORY_SEPARATOR.'Repository'.\DIRECTORY_SEPARATOR.'EmargerRepository.php';

        return $container->privates['App\\Repository\\EmargerRepository'] = new \App\Repository\EmargerRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)));
    }
}
